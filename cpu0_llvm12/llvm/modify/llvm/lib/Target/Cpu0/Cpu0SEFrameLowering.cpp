...
Cpu0SEFrameLowering::Cpu0SEFrameLowering(const Cpu0Subtarget &STI)
    : Cpu0FrameLowering(STI) {}

//@emitPrologue {

void Cpu0SEFrameLowering::emitPrologue(MachineFunction &MF, MachineBasicBlock &MBB){
...
const Cpu0FrameLowering *llvm::createCpu0SEFranmeLowering(const Cpu0Subtarget &ST) {
