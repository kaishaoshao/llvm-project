...
public:
    ...
    bool isCpu32I() const { return Cpu0ArchVersion >= Cpu32II; }

    bool hasCpu032II() const { return Cpu0ArchVersion >= Cpu32II; }
    bool isCpu32II() const { return Cpu0ArchVersion >= Cpu32II; }
